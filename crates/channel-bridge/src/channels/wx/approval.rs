...
use super::store::{save_session, SessionState, WcSession};
use crate::i18n::tr;
...
/// 通道默认自托管，不在微信内弹出工具审批；保留 API 供将来显式 opt-in。
pub(crate) fn should_register_wechat_approval(_ignore_approval: bool) -> bool {
    false
}
...
mod tests {
    ...
    #[test]
    fn channel_self_hosted_skips_wechat_approval_callback() {
