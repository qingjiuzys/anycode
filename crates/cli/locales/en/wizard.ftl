...
cfg-wechat-hint-non-tty = To bind WeChat and install autostart bridge: anycode channel wechat
...
cfg-no-config-run =    Run: anycode setup — or open the Digital Workbench (/setup) to configure in the browser
