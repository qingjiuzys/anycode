...
repl-help-equiv-line1 = Each line continues this line-REPL session (multi-turn, same engine as TUI). One-shot equivalent:
repl-help-equiv-line2 =   anycode run -C "{$cwd}" --agent {$agent} "…"
