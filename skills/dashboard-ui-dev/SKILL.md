...
After UI changes, run TypeScript/build checks if available in the project scripts, and exercise the page in the running dashboard when the user has `anyCode Workbench` up.
