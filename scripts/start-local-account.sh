...
CORS_ORIGINS="http://127.0.0.1:43180,http://localhost:43180,http://127.0.0.1:${ANYCODE_LOCAL_ACCOUNT_PORTAL_PORT},http://localhost:${ANYCODE_LOCAL_ACCOUNT_PORTAL_PORT},http://127.0.0.1:${ANYCODE_LOCAL_ACCOUNT_API_PORT},http://localhost:${ANYCODE_LOCAL_ACCOUNT_API_PORT}"
